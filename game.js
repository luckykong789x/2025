...
class Player {
    ...
    draw() {
        ...
        ctx.fillRect(this.x + 4, this.y, 12, 10);
        ...
        if (this.frame === 0) {
            ctx.fillRect(this.x + 4, this.y + 22, 5, 10);
            ctx.fillRect(this.x + 11, this.y + 23, 5, 9);
        } else {
            ctx.fillRect(this.x + 5, this.y + 23, 5, 9);
            ctx.fillRect(this.x + 10, this.y + 22, 5, 10);
        }
    }
}
